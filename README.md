...
```
Внимание! Ключи https лучше генерировать свои, и не раскрывать свой ключ CA.
Данные ключи в папке certs только для примера.
...
Чтобы браузер не ругался на https, запускаем localhost.p12, далее-далее. 
