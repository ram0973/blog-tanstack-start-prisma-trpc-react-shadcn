Блог c админкой, https, авторизацией по паролю и OAuth
...
```
В папке certs лежат ключи шифрования для разработки. В readme.txt инструкция как сгенерировать ключи заново (в linux или wsl). Чтобы браузер не ругался на https, запускаем localhost.p12, далее-далее. При этом в хранилище сертификатов добавятся 2 сертификата для локальной разработки.
